...
<head>
    ...
    <style>
        ...
        .page-header p  { font-size: 0.95rem; color: var(--text-color); margin-top: 4px; }
...
<div class="page-wrapper">
    ...
    <div class="page-header">
        <div>
            ...
            <p>Welcome, <strong><?= htmlspecialchars($_SESSION['firstname']) ?></strong> &nbsp;|&nbsp; Role: Caretaker</p>
        </div>
    ...
    <div class="table-wrap">
        ...
        <table>
            ...
            <tr class="<?= $isLow ? 'low-food' : '' ?>">
                ...
                <td>
                    <form method="POST" action="caretaker.php">
                ...
                <td>
                    ...
                    <form method="POST" action="caretaker.php" class="restock-form">

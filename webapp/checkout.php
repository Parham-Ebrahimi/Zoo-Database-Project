...
<head>
    ...
    <style>
        ...
        .checkout-card { background:var(--cr-surface); border:1px solid var(--cr-border); border-radius:16px; padding:1.5rem; box-shadow:0 4px 24px rgba(26,46,22,.07); margin-bottom:1.25rem; }
        .checkout-card h2 { font-size:.95rem; font-weight:700; text-transform:uppercase; letter-spacing:.05em; color:var(--cr-muted); margin:0 0 1rem; padding-bottom:.6rem; border-bottom:1px solid var(--cr-border); }

        .review-row { display:flex; justify-content:space-between; align-items:center; padding:.55rem 0; border-bottom:1px solid #eef2eb; font-size:.9rem; }
        .review-row:last-child { border-bottom:none; }
        .review-row .label { color:var(--cr-text); }
        .review-row .price { font-weight:700; color:var(--cr-accent); }
        .review-row .meta  { font-size:.78rem; color:var(--cr-muted); margin-top:.15rem; }

        .section-sub { font-size:.78rem; text-transform:uppercase; letter-spacing:.06em; color:var(--cr-muted); font-weight:600; margin:.85rem 0 .4rem; }
        ...
        .payment-label {
            ...
            border:2px solid var(--cr-border); border-radius:10px; cursor:pointer;
        ...
        /* Success state */
        .success-wrapper { text-align:center; padding:3rem 1rem; max-width:540px; margin:0 auto; }
        .success-icon { font-size:4rem; display:block; margin-bottom:1rem; }
        .success-wrapper h1 { font-size:1.75rem; font-weight:700; margin:0 0 .5rem; color:var(--cr-accent); }
        .success-wrapper p  { color:var(--cr-muted); margin:0 0 2rem; line-height:1.6; }
        .success-links { display:flex; flex-wrap:wrap; gap:.75rem; justify-content:center; }
        .success-link { padding:.65rem 1.5rem; border-radius:999px; font-weight:600; font-size:.9rem; text-decoration:none; }
        .success-link.primary { background:var(--cr-accent); color:white; }
        .success-link.primary:hover { background:#1a5c2b; }
        .success-link.outline { border:1px solid var(--cr-accent); color:var(--cr-accent); }
        .success-link.outline:hover { background:#eef6ea; }
...
<div class="cr-shell">
    <header class="cr-topbar">
        ...
        <nav class="zoo-nav">
            ...
            <a href="cart.php" class="cr-btn-outline">← Back to cart</a>
        ...
        <div class="checkout-layout">
            ...
            <div>
                ...
                <div class="checkout-card">
                    ...
                    <p class="section-sub">🎟️ Tickets</p>
                    ...
                    <p class="section-sub">🍽️ Restaurant</p>

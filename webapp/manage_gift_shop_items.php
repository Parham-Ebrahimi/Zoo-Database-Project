...
<body>
                        ...
                        <table class="manage-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="delete_gift_shop_item.php" class="js-del-gift-item" data-item-name="<?= htmlspecialchars($row['ItemName']) ?>" style="display:inline;margin:0">
    ...
    <div id="delete-gift-modal" class="ui-modal" hidden role="dialog" aria-modal="true" aria-labelledby="delete-gift-modal-title">
        <div class="ui-modal__backdrop" data-close-delete-modal></div>
        <div class="ui-modal__card">
            <h2 id="delete-gift-modal-title" class="ui-modal__title">Remove gift shop item?</h2>
            <p id="delete-gift-modal-text" class="ui-modal__text"></p>
            <div class="ui-modal__actions">
                <button type="button" class="ui-btn ui-btn--cancel" data-close-delete-modal>Cancel</button>
                <button type="button" class="ui-btn ui-btn--confirm" id="delete-gift-modal-confirm">Remove item</button>
            </div>
        </div>
    </div>
    <script>
        (function () {
            var modal = document.getElementById('delete-gift-modal');
            var textEl = document.getElementById('delete-gift-modal-text');
            var confirmBtn = document.getElementById('delete-gift-modal-confirm');
            ...
            function openModal(form) {
                ...
                textEl.innerHTML = 'You are about to remove <strong>' + name.replace(/</g, '&lt;') + '</strong> from the gift shop catalog. This cannot be undone.';
                modal.hidden = false;

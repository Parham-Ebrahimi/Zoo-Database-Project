...
<body>
    ...
    <div class="animal-hero">
        <img src="https://images.unsplash.com/photo-1616128417743-c3a6992a65e7?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Jaguar at Greenwood Zoo">
    ...
    <main class="animal-detail">
        ...
        <?php
require_once __DIR__ . '/../db.php';
$animalSpecies  = "Jaguar";
$animalKeywords = "Jaguar";
$animalLabel    = "Jaguar";

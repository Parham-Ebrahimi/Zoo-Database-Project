        ...
        <div class="gs-inner">
            <header class="gs-header">
                <div>
                    ...
                    <p class="gs-lead">
                        New products show up on the customer gift shop immediately. Add a clear name, price, and stock count,
                        and upload a photo so the card looks right in the store.
                    </p>
                    <p class="gs-meta">Signed in as <?= $firstname ?></p>
                </div>
                <a class="gs-back" href="dashboard.php#gift-shop-admin">← Back to dashboard</a>
            </header>
                ...
                <?php else: ?>
                    <form method="post" enctype="multipart/form-data" action="" id="gs-add-form">
                        ...
                        <div class="gs-actions">
                            ...
                            <a class="gs-btn gs-btn--ghost" href="giftshop.php?preview=1" target="_blank" rel="noopener">Preview gift shop</a>
                        </div>
                    </form>
                <?php endif; ?>
            </div>
